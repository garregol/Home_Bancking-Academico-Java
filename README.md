# Sistema de Gestión de Home Banking (Proyecto Académico)
...
* **Gestión de Usuarios (CRUD):** Permite crear, modificar y eliminar usuarios (clientes) del sistema.
* **Gestión de Productos:** Creación de nuevas tarjetas de crédito/débito para los clientes.
* **Auditoría y Monitoreo:** Acceso a un registro detallado de todos los movimientos y transacciones realizados en el sistema.

### 2. Perfil Cliente
* **Consulta de Cuentas:** Visualización de saldos y detalles de cuentas propias.
